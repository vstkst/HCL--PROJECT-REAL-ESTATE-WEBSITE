...
<!-- widget mortgage calculator=============================-->
     ...
     <form class="mb-0" method="post" action="calculator.php">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="saleprice" id="saleprice" placeholder="Sale price" required="true">
                                    </div>
                                    <!-- .form-group end -->
                                    <div class="form-group">
                                        <label for="down-payment">Down Payment</label>
                                        <input type="text" class="form-control" name="downpayment" id="downpayment" placeholder="Downpayment" required="true">
                                    </div>
                                    <!-- .form-group end -->
                                    <div class="form-group">
                        ...
                        <!-- . widget mortgage calculator end -->
                         <div class="form-group">
				<form method="POST">
					<input type="text" name="code" class="form-control" value="<?php echo (isset($firstname))?$firstname:'';?>">
            ...
            <!-- .container -->
            <div class="property-single-leave-review inner-box"><div class="gmap_canvas"><iframe width="1270" height="500" id="gmap_canvas" src="<?php echo (isset($firstname2))?$firstname2:'';?>" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.embedgooglemap.net/text-tools/"></a></div><style>.mapouter{position:relative;text-align:right;height:500px;width:1270px;}.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:1270px;}</style></div>
